                    ...
                    <div className="relative w-[1000px] h-[600px] border-[20px] m-10 border-purple-500 flex ">
                        <div className="flex flex-col mx-auto">
                            <div className="flex text-center mx-auto">
                                <p className="mr-2">
                                    <img src={glogo} alt="logo" className="w-[80px] " />
                                </p>
                                <p className="w-[1px] h-[50px] bg-purple-600 mt-4 "></p>
                                <p className="ml-4 w-[80px] ">
                            ...
                            <div className=" text-center mx-auto pt-5 pb-10 w-[1000px] h-[200px] mt-5 ">
                                <p className="text-3xl font-semibold border-b-2 mx-[300px] pb-2 mb-1 border-purple-800 border-dashed "> {formData.name} </p>
                                <p>
