            ...
            <div className="flex flex-col mx-auto">
              ...
              <div className="text-center mx-auto pt-5 pb-10 w-[1000px] h-[200px] mt-5">
                ...
                <p className="mx-28 pt-5 text-md">
                  For successfully participating in the Biopython and R for Genomics and Bioinformatics crash course which covered extraction of sequences and features from genomic datasets, automation of genomic tasks with biopython, analysis and visualization of gene expression data.
                </p>
                <p className="font-bold">21st - 22nd APRIL 2025</p>
              </div>
