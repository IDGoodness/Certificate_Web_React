  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-lg lg:w-fit lg:h-auto bg-white p-6 shadow-2xl rounded-xl">
        <h1 className="text-center text-3xl text-white p-5 rounded-t-xl bg-purple-950">
        ...
        <form id="certificateForm" className="p-5" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2">
            <div className="py-2 mr-1 ">
              <input
                ...
                name="name"
                placeholder="Graduant Name"
                required
                className="w-full rounded-xl p-2 pl-3 outline outline-1 hover:outline-purple-800"
              />
            </div>
            ...
            <div className="py-2 ml-1 relative">
              <select
                ...
                onChange={handleChange}
                placeholder="Course"
                className="w-full h-10 rounded-xl pl-3 outline outline-1 appearance-none hover:outline-purple-800 transition-colors duration-200 "
              >
                ...
                <option
                  ...
                  className=" appearance-none hover:bg-"
                >
                  Microbial Genomics
                </option>
                ...
                <option value="Animal Genomics">Animal Genomics</option>
          ...
          <button
            type="submit"
            className="bg-purple-950 text-white p-3 my-5 rounded-full w-full hover:bg-purple-900"
          >
